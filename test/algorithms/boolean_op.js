...
describe('#Algorithms.Boolean Operations', function () {
    describe('#Algorithms.Boolean Union', function () {
        ...
        it('Can perform unify - throw error. Infinite loop for boolean union over (valid) polygons. Issue #55 case 1', function () {
            "use strict";
...
// const z0Surface = [[[1, 1, 0], [9, 1, 0], [9, 9, 0], [1, 11, 0]]]; // subtraction works when not producing holes
    ...
    describe('#Algorithms.Boolean Intersection', function () {
        ...
        it('Throw error on infinite loop for boolean intersection over (valid) polygons. Issue #55 case 1', function () {
            "use strict";
