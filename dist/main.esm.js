...
export { Arc, BOUNDARY, Box, CCW, CONTAINS, CW, Circle, Distance, Edge, errors as Errors, Face, INSIDE, INTERLACE, Line, Matrix, ORIENTATION, OUTSIDE, OVERLAP_OPPOSITE, OVERLAP_SAME, PlanarSet, Point, Polygon, Ray, Segment, Utils, Vector, arc, box, circle, disjoint, equals, intersects, inverse, line, matrix, point, ray, ray_shoot, relate, segment, touches, vector };
